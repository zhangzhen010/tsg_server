...
import com.game.solana.timer.SolanaNftMintTimer;
...
public class WebServer extends Server implements CommandLineRunner {
    ...
    private @Resource SolanaNftMintTimer solanaNftMintTimer;
    ...
    public void run(String... args) {
        try {
            ...
            solanaNftThread.addTimerEvent(solanaNftMintTimer);
            ...
            super.run();
            // 启动成功
            log.info("webGame后台服务器启动成功8");
        } catch (Exception e) {
            log.error("webGame后台服务器启动异常", e);
        }
    }
