...
public class MetadataArg {
    ...
    public MetadataArg(String name, String symbol, String uri, long timestamp) {
        this.name = name;
        this.symbol = symbol;
        this.uri = uri;
    ...
    public static MetadataArg fromBytes(byte[] bytes) {
        ...
        return new MetadataArg(name, symbol, uri, timestamp);
    }
